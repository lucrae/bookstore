...
public class PageAdmin extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException  {
        ...
        toClient.println("<div><a style='padding-right:15px' href='/users.html'>Users</a><a style='padding-right:15px' href='/books.html'>Books</a><a href='/''>Sign Out</a></div>");
        ...
        toClient.println("<p>To see a list of all <strong>users</strong> press <a href='/UserList'>here.</a></p>");
        toClient.println("<p>To see a list of all <strong>books</strong> press <a href='/BookList'>here.</a></p>");
